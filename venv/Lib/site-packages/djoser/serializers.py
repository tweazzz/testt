...
class TokenCreateSerializer(serializers.Serializer):
    ...
    default_error_messages = {
        ...
        "invalid_role": _("Invalid user role for this endpoint."),
    }
    ...
    def validate(self, attrs):
        ...
        if self.user and self.user.is_active:
            if 'client' in self.context.get("request").path and self.user.role != 'client':
                self.fail("invalid_role")
            elif 'admin' in self.context.get("request").path and self.user.role != 'admin':
                self.fail("invalid_role")
            return attrs
